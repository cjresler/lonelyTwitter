...
public class IntentReaderActivityTest extends ActivityInstrumentationTestCase2{
    ...
    public void testDoubleText(){
        ...
        IntentReaderActivity intentReaderActivity = (IntentReaderActivity) getActivity();
        assertEquals("The text should be replaced!", "Test message 4Test message 4",
...
//-------------------------------------------------------------------------------
    public void testReverseText(){
        ...
        IntentReaderActivity intentReaderActivity = (IntentReaderActivity) getActivity();
        assertEquals("The text should be reversed!", "cba",
                intentReaderActivity.getText());
    }
    ...
    public void testDefaultMessage(){
        ...
        IntentReaderActivity intentReaderActivity = (IntentReaderActivity) getActivity();
        assertEquals("The text should be replaced!", "default value",
                intentReaderActivity.getText());
    }

    public void testViewOnScreen(){
        Intent intent = new Intent();
        intent.putExtra(IntentReaderActivity.TEXT_TO_TRANSFORM_KEY, "Test message5");
        intent.putExtra(IntentReaderActivity.MODE_OF_TRANSFORM_KEY, IntentReaderActivity.NORMAL);
        setActivityIntent(intent);
